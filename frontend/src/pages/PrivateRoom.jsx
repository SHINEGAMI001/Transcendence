                     ...
                     return (
                        <div key={friend.username} className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-white/10">
                           ...
                           <button
                              ...
                              className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${isInvited ? 'bg-violet-500/20 text-violet-400 cursor-not-allowed border border-violet-500/30' :
                     ...
                     <div className="bg-cyan-900/10 border border-cyan-500/30 rounded-3xl p-6 space-y-4 backdrop-blur-md shadow-[0_0_50px_rgba(34,211,238,0.05)_inset]">
                        {blueTeam.map((slot, idx) => (
                           <div
                              ...
                              className={`h-24 rounded-2xl border-2 transition-all duration-300 flex items-center px-6 gap-6 relative overflow-hidden ${slot
                     ...
                     <div className="bg-rose-900/10 border border-rose-500/30 rounded-3xl p-6 space-y-4 backdrop-blur-md shadow-[0_0_50px_rgba(244,63,94,0.05)_inset]">
                        {redTeam.map((slot, idx) => (
                           <div
                              ...
                              className={`h-24 rounded-2xl border-2 transition-all duration-300 flex items-center px-6 gap-6 relative overflow-hidden flex-row-reverse text-right ${slot
